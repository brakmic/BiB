...
export default class MediaTypeController {
    ...
    public getMediaType(request: Hapi.Request, reply: Hapi.IReply) {
    ...
    public insertMediaType(request: Hapi.Request, reply: Hapi.IReply) {
    ...
    public updateMediaType(request: Hapi.Request, reply: Hapi.IReply) {
        const mediaType: IMediaType = request.payload;
    ...
    public deleteMediaType(request: Hapi.Request, reply: Hapi.IReply) {
        const id = Number(request.params['id']);
