...
export default class MediaController {
    ...
    public getMedia(request: Hapi.Request, reply: Hapi.IReply) {
    ...
    public insertMedium(request: Hapi.Request, reply: Hapi.IReply) {
    ...
    public updateMedium(request: Hapi.Request, reply: Hapi.IReply) {
        const medium: IMedium = request.payload;
    ...
    public deleteMedium(request: Hapi.Request, reply: Hapi.IReply) {
        const id = Number(request.params['id']);
    ...
    public isBorrowed(request: Hapi.Request, reply: Hapi.IReply) {
        const id = Number(request.params['id']);
